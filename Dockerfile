...
RUN python -m pip install -U pip setuptools wheel && \
    ...
    python -m pip install -U quartical@git+https://github.com/ratt-ru/QuartiCal@main && \
    python -m pip install -U pfb-clean@git+https://github.com/ratt-ru/pfb-clean@master && \
