...
pipeline ones (`*_groundtruth`, the imager/deconv/restore/hci and degrid drivers, and the
end-to-end degrid null) plus a few whose cost is Ray actor startup or a dense operator build
