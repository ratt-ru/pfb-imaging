...
@stimela_cab(
    name="ista",
    info="pfb version of the Iterative Shrinkage-Thresholding Algorithm (ISTA).",
)
@stimela_output(
    dtype="Directory",
    name="dds-out",
...
def ista(
    ...
    fb_tol: Annotated[
        float,
        typer.Option(
            help="Tolreance of primal forward=backward algorithm.",
        ),
    ] = 0.0003,
    fb_maxit: Annotated[
        int,
        typer.Option(
            help="Maximum iterations for primal forward=backward algorithm.",
        ),
    ] = 450,
    fb_verbose: Annotated[
        int,
        typer.Option(
            help="Verbosity of primal forward=backward algorithm. Set to > 1 for debugging, 0 for silence",
        ),
    ] = 1,
    fb_report_freq: Annotated[
        int,
        typer.Option(
            help="Report frequency of primal forward=backward algorithm",
        ),
    ] = 50,
    pm_tol: Annotated[
        float,
    ...
    """
    pfb version of the Iterative Shrinkage-Thresholding Algorithm (ISTA).
    """
    # Lazy import the core implementation
    from pfb_imaging.core.ista import ista as ista_core  # noqa: E402
