...
def _spotless(**kw):
    ...
    from pfb_imaging.opt.power_method import power_method_dist as power_method
    from pfb_imaging.opt.primal_dual import primal_dual_dist as primal_dual
    from pfb_imaging.utils.naming import xds_from_url, get_opts, cache_opts
    from pfb_imaging.utils.fits import load_fits, dds2fits, set_wcs, save_fits
