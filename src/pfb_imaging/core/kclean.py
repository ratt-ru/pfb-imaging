...
def _kclean(**kw):
    ...
    import numpy as np
    import xarray as xr
    from pfb_imaging.utils.fits import set_wcs, save_fits, load_fits
...
def _fskclean(**kw):
    ...
    import xarray as xr
    from pfb_imaging.utils.fits import set_wcs, save_fits, load_fits
    from pfb_imaging.deconv.clark import fsclark
    from pfb_imaging.utils.naming import xds_from_url
    from pfb_imaging.operators.gridder import compute_residual
    from pfb_imaging.operators.hessian import fshessian_jax
    from scipy import ndimage
    from pfb_imaging.utils.modelspec import fit_image_fscube
