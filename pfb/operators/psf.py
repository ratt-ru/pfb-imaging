...
class PSF2(object):
    def __init__(self, psf, nthreads=1, imsize=None, mask=None, beam=None):
        """
        The difference between PSF and PSF2 is that PSF2 does not apply the
        mask and the beam after convolution. This is convenient when cleaning
        because we have to do peak finding and sidelobe subtraction in the
        apparent images i.e. residual = R.H W (V - R A x). 
        """
