...
def residual(ms, **kw):
    '''
    Create a residual image given a model and a list of measurement sets.
    The residual image cube is not normalised by wsum as this destroyes
